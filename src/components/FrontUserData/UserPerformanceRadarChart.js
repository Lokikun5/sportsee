...
const UserPerformanceRadarChart = ({ data }) => {
    return (
        <div className="c-graph" style={{ background: 'black', width: '258px', height: '253px', padding: '10px', borderRadius: '5px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <RadarChart  outerRadius={90} width={258} height={253} data={data}>
                <PolarGrid radialLines={false}/>
                <PolarAngleAxis dataKey="subject" stroke="white" tick={{ fill: 'white', fontSize: 10 }} tickLine={false}  />
